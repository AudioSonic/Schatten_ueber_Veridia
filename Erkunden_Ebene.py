...
def plain(root, parent_frame):  
    ...
    def examine():
        if pc_loc[0] == 0 and pc_loc[1] == 0:
            ...
            Dialog.update_text(Ebene_5_Examine)  
            ...
            Dialog.update_text(Ebene_9_Examine)            
    ...
    def touch():
        if pc_loc[0] == 0 and pc_loc[1] == 0:
            ...
            Dialog.update_text(Ebene_5_Touch)  
        elif pc_loc[0] == 1 and pc_loc[1] == 2:
            Dialog.update_text(Ebene_6_Touch)  
        elif pc_loc[0] == 2 and pc_loc[1] == 0:
            Dialog.update_text(Ebene_7_Touch) 
        elif pc_loc[0] == 2 and pc_loc[1] == 1:
            Dialog.update_text(Ebene_8_Touch) 
        elif pc_loc[0] == 2 and pc_loc[1] == 2:
            Dialog.update_text(Ebene_9_Touch) 

    def perceive():
        if pc_loc[0] == 0 and pc_loc[1] == 0:
            Dialog.update_text(Ebene_1_Perceive)
        elif pc_loc[0] == 0 and pc_loc[1] == 1:
            Dialog.update_text(Ebene_2_Perceive)
        elif pc_loc[0] == 0 and pc_loc[1] == 2:
            Dialog.update_text(Ebene_3_Perceive)   
        elif pc_loc[0] == 1 and pc_loc[1] == 0:
            Dialog.update_text(Ebene_4_Perceive)   
        elif pc_loc[0] == 1 and pc_loc[1] == 1:
            Dialog.update_text(Ebene_5_Perceive)  
        elif pc_loc[0] == 1 and pc_loc[1] == 2:
            ...
            Dialog.update_text(Ebene_9_Perceive) 

    def pickup():
        if pc_loc[0] == 0 and pc_loc[1] == 0:
            Dialog.update_text(Ebene_1_PickUp)
        elif pc_loc[0] == 0 and pc_loc[1] == 1:
            Dialog.update_text(Ebene_2_PickUp)
        elif pc_loc[0] == 0 and pc_loc[1] == 2:
            Dialog.update_text(Ebene_3_PickUp)   
        elif pc_loc[0] == 1 and pc_loc[1] == 0:
            Dialog.update_text(Ebene_4_PickUp)   
        elif pc_loc[0] == 1 and pc_loc[1] == 1:
            Dialog.update_text(Ebene_5_PickUp)  
        elif pc_loc[0] == 1 and pc_loc[1] == 2:
            Dialog.update_text(Ebene_6_PickUp)  
        elif pc_loc[0] == 2 and pc_loc[1] == 0:
            Dialog.update_text(Ebene_7_PickUp) 
        elif pc_loc[0] == 2 and pc_loc[1] == 1:
            Dialog.update_text(Ebene_8_PickUp) 
        elif pc_loc[0] == 2 and pc_loc[1] == 2:
            Dialog.update_text(Ebene_9_PickUp) 
    ...
    def MapButton():
            ...
            def HoehleButton(root, parent_frame):
                ...
                bg_label.place_forget()
                Map.destroy()
                Hoehlen.cave(root, parent_frame)
    ...
    loc.insert(tk.END, "Ebene von Veridia")
    coord.insert(tk.END, " Location: " + str(pc_loc))
