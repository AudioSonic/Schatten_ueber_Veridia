...
def cave(root, parent_frame):  
    ...
    def examine():
        if pc_loc[0] == 0 and pc_loc[1] == 0:
            ...
            Dialog.update_text(Hoehle_2_Examine)
        elif pc_loc[0] == 0 and pc_loc[1] == 2:
            Dialog.update_text(Hoehle_3_Examine)   
        elif pc_loc[0] == 1 and pc_loc[1] == 0:
            Dialog.update_text(Hoehle_4_Examine)   
            ...
            if Gegnerliste.Vorluna_Boss[8] == 1:    
                Edelete()
    ...
    def touch():
        if pc_loc[0] == 0 and pc_loc[1] == 0:
            Dialog.update_text(Hoehle_1_Touch)
        elif pc_loc[0] == 0 and pc_loc[1] == 1:
            Dialog.update_text(Hoehle_2_Touch)
        elif pc_loc[0] == 0 and pc_loc[1] == 2:
            Dialog.update_text(Hoehle_3_Touch)   
        elif pc_loc[0] == 1 and pc_loc[1] == 0:
            Dialog.update_text(Hoehle_4_Touch)   
        elif pc_loc[0] == 1 and pc_loc[1] == 1:
            Dialog.update_text(Hoehle_5_Touch)  
        elif pc_loc[0] == 1 and pc_loc[1] == 2:
            Dialog.update_text(Hoehle_6_Touch)  
        elif pc_loc[0] == 2 and pc_loc[1] == 0:
            Dialog.update_text(Hoehle_7_Touch) 
        elif pc_loc[0] == 2 and pc_loc[1] == 1:
            Dialog.update_text(Hoehle_8_Touch) 
        elif pc_loc[0] == 2 and pc_loc[1] == 2:
            Dialog.update_text(Hoehle_9_Touch) 

    def perceive():
        if pc_loc[0] == 0 and pc_loc[1] == 0:
            Dialog.update_text(Hoehle_1_Perceive)
        elif pc_loc[0] == 0 and pc_loc[1] == 1:
            Dialog.update_text(Hoehle_2_Perceive)
        elif pc_loc[0] == 0 and pc_loc[1] == 2:
            Dialog.update_text(Hoehle_3_Perceive)   
        elif pc_loc[0] == 1 and pc_loc[1] == 0:
            Dialog.update_text(Hoehle_4_Perceive)   
        elif pc_loc[0] == 1 and pc_loc[1] == 1:
            Dialog.update_text(Hoehle_5_Perceive)  
        elif pc_loc[0] == 1 and pc_loc[1] == 2:
            Dialog.update_text(Hoehle_6_Perceive)  
        elif pc_loc[0] == 2 and pc_loc[1] == 0:
            Dialog.update_text(Hoehle_7_Perceive) 
        elif pc_loc[0] == 2 and pc_loc[1] == 1:
            Dialog.update_text(Hoehle_8_Perceive) 
        elif pc_loc[0] == 2 and pc_loc[1] == 2:
            Dialog.update_text(Hoehle_9_Perceive) 

    def pickup():
        if pc_loc[0] == 0 and pc_loc[1] == 0:
            Dialog.update_text(Hoehle_1_PickUp)
        elif pc_loc[0] == 0 and pc_loc[1] == 1:
            Dialog.update_text(Hoehle_2_PickUp)
        elif pc_loc[0] == 0 and pc_loc[1] == 2:
            Dialog.update_text(Hoehle_3_PickUp)   
        elif pc_loc[0] == 1 and pc_loc[1] == 0:
            Dialog.update_text(Hoehle_4_PickUp)   
        elif pc_loc[0] == 1 and pc_loc[1] == 1:
            Dialog.update_text(Hoehle_5_PickUp)  
        elif pc_loc[0] == 1 and pc_loc[1] == 2:
            Dialog.update_text(Hoehle_6_PickUp)  
        elif pc_loc[0] == 2 and pc_loc[1] == 0:
            Dialog.update_text(Hoehle_7_PickUp) 
        elif pc_loc[0] == 2 and pc_loc[1] == 1:
            Dialog.update_text(Hoehle_8_PickUp) 
        elif pc_loc[0] == 2 and pc_loc[1] == 2:
            Dialog.update_text(Hoehle_9_PickUp) 
    ...
    loc.insert(tk.END, "Cave in the Woods")
    coord.insert(tk.END, " Location: " + str(pc_loc))
