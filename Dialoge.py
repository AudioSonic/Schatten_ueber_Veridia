...
Veridia_4 = "A stone well, covered in moss and vines, sits in the misty square. The well seems to have been unused for a long \ntime, and silhouettes gather around it, perhaps drawing water or sharing stories."
...
Veridia_7 = "A cobblestone path leads deeper into the village, vanishing into the mist. The occasional silhouettes seem to move \nwith purpose, creating an aura of enigma."
...
Veridia_4_Examine = "A moss-covered well stands as a forgotten relic, partially obscured by the mist. A small Silhouette stands in front \nof it, it's purpose and storiy veiled by the ethereal atmosphere."
Veridia_4_Touch = "The stone of the well feels damp and slightly slippery beneath your hand. The silhouette occasionally leans over, \nbut it's difficult to see what this person is doing."
Veridia_4_Perceive = "The forgotten well seems to be a focal point for the whole marketplace. Their movements and actions remain a \nmystery, as if they guard the village's untold tales."
Veridia_4_PickUp = "Around the well, you find nothing to pick up, but the silhouette bring an element of intrigue to this quiet gathering \nplace."
...
Veridia_7_Examine = "A cobblestone path leads deeper into the village, disappearing into the mist. The silhouettes in the distance seem to \nmove with purpose, their intentions concealed."
Veridia_7_Touch = "The cobblestones are solid and reliable beneath your feet, providing a clear path through the mist. The silhouettes \ncreate an intriguing tapestry of movement in the fog."
Veridia_7_Perceive = "The path leads into the village's heart, and the silhouettes suggest that there's more to discover. Their presence hints \nat a world of hidden stories and mysteries."
Veridia_7_PickUp = "On the cobblestone path, you find nothing to pick up, but the silhouettes beckon you to follow, as if they know the way to the \nvillage's secrets."
