...
def Ending_2(root, parent_frame):
    ...
    vrd_pfad = Image.open(Veridia_Ending)
    ...
    values = [Outro_3, Outro_4, Outro_5, Outro_6, Outro_7, Outro_8, Outro_9, Outro_10]
    ...
    def dialogmanager(dialog_index):
        ...
        if 0 <= dialog_index < len(values):
            ...
            Ending_3.Ending_3(root, parent_frame)
