...
Gegner_Ebene = [100, 5, 10, 10, Gegner_Ebene, Dialoge.Gegner_Ebene_Dialog, "Wolf",]
Gegner_Hoehle = [70, 10, 15, 20, Gegner_Hoehle, Dialoge.Gegner_Hoehle_Dialog, "Undead"]
Gegner_Kueste = [80, 10, 10, 20, Gegner_Kueste, Dialoge.Gegner_Kueste_Dialog, "Gouhl"]
Gegner_Morast = [90, 5, 10, 30, Gegner_Morast, Dialoge.Gegner_Morast_Dialog, "Berserk"]
Gegner_Wald = [60, 10, 20, 20, Gegner_Wald, Dialoge.Gegner_Wald_Dialog, "Rider"]
